...
# the nex line Identifies the project route.
import os
RUTA_PROYECTO = os.path.dirname(os.path.realpath(__file__))

#Leave this line in False when you pass to production phase.
#DEBUG = False, 
DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
		('Leonardo Collazos Paez', 'leo011093@hotmail.com'),
)

MANAGERS = ADMINS

#the name of the database it has to be in a complete route
#in case of "Windows" type the direction of the database with simple commas.
#'NAME': '/project_route/recetario3/rec.db',
DATABASES = {
    'default': {
