...
class Bebida(models.Model):
    nombre = models.CharField(max_length=50, verbose_name='Título', unique=True)
    ingredientes = models.TextField(help_text='Redacta los ingredientes')
    preparacion = models.TextField(verbose_name='Preparación', help_text='El proceso de preparación')
    imagen = models.ImageField(upload_to='bebidas', verbose_name='Imágen')
...
class Postre(models.Model):
    ...
    ingredientes = models.TextField(help_text='Redacta los ingredientes')
    preparacion = models.TextField(verbose_name='Preparación', help_text='El proceso de preparación')
    imagen = models.ImageField(upload_to='postres', verbose_name='Imágen')
    tiempo_registro = models.DateTimeField(auto_now=True)
    usuario = models.ForeignKey(User)
...
class Comentario(models.Model):
    ...
    postre = models.ForeignKey(Postre)
